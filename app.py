#app.py will be containing the front end interface if the project with the use of modul such as streamlit and pandas 
# and integraction with files like chatbot_logic will be established here. the heavy lifting for the front end will be done by streamlit module 
